const { getAllAccesos, createAccesos, deleteAcceso, updateAcceso } = require("../../controllers/usuarios/accesoControllers");
...
module.exports ={getAccesosHandler,createAccesosHandler, deleteAccesoHandler, updateAccesoHandler }