const { getAllPais, createPais, deletePais } = require("../../controllers/clientesProveedores/paisesControllers");
...
module.exports ={getPaisHandler, createPaisHandler, deletePaisHandler};
