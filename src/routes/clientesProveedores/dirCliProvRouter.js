...
const {getDirCliProvHandler,createDirCliProvHandler, deleteDirCliProvHandler, updateDirCliProvHandler} = require("../../handlers/clientesProveedores/dirCliProvHandlers");
